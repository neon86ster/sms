 ...
 */
 include("include.php");
  //For insert page into table s_grouptemplate.
  ...
  //For insert page into table s_upage.
  ...
  $update = "delete from s_upage where page_priority=0";
  $object->setResult($update);
  $update = "delete from s_upage where user_id not in (select u_id from s_user)";
  $object->setResult($update);
  $update = "delete from s_grouptemplate where page_priority=0";
  $object->setResult($update);
  $update = "delete from s_grouptemplate where group_id not in (select group_id from s_group)";
  $object->setResult($update);
  
  $values = array(); // Keep all value for insert into table s_grouptemplate.
  $countValue = 0;
