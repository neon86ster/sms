 ...
 * 
 * Generate mainmenu table for all report
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="mainheader">
	...
	<tr>
		...
		<td height="47" align="right"  style="background-image: url('/images/<?=$theme?>/header.png');">
						...
						<img src="/images/separate.png" />&nbsp;&nbsp;&nbsp;&nbsp;
						<!--<a href="javascript:;" onclick="window.open('<?=$print?>','<?=$pageinfo["pagename"]?>','resizable=yes,menubar=no,scrollbars=yes')" target="_parent"><img src="/images/<?=$theme?>/print.png" border="0" title="Print" /></a>&nbsp;&nbsp;&nbsp;&nbsp;
						<img src="/images/separate.png" />&nbsp;&nbsp;&nbsp;&nbsp;-->
