...
/*
 * for get each td size of each table
 * return td width of each table
 */
	function getTdSize($numTd,$pgWidth){
		//echo "<br>".$pgWidth/$numTd;
		if(!$numTd){
			$numTd=1;
		}
		return $pgWidth/$numTd;
	}
?>
