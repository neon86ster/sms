...
$all_total=0;
   ...
   $sql1="select c_bpds_link.bpds_id, bl_branchinfo.branch_id,bl_branchinfo.branch_name,a_bookinginfo.book_id,c_srdetail.*" .
   		",if(c_srdetail.set_sc=1,(c_srdetail.qty*c_srdetail.unit_price*(100+bl_branchinfo.servicescharge)/100),(c_srdetail.qty*c_srdetail.unit_price)) as sub_total" .
...
$sql2="select c_bpds_link.bpds_id,bl_branchinfo.branch_id,bl_branchinfo.branch_name,c_saleproduct.pds_id as book_id,c_srdetail.*" .
		",if(c_srdetail.set_sc=1,(c_srdetail.qty*c_srdetail.unit_price*(100+bl_branchinfo.servicescharge)/100),(c_srdetail.qty*c_srdetail.unit_price)) as sub_total" .
		",if(c_srdetail.set_tax=1,if(c_srdetail.set_sc=1,((c_srdetail.qty*c_srdetail.unit_price*(100+bl_branchinfo.servicescharge))/100),c_srdetail.qty*c_srdetail.unit_price)*((select tax_percent from l_tax where tax_id=bl_branchinfo.tax_id)/100),0)as vat " .
...
$total_sub=0;
	...
	$total=$total_sub+$total_vat;
   
   $all_total_sub+=$total_sub;
   $all_total_vat+=$total_vat;
   $all_total+=$total;
   ?>
   <tr height="20">
