...
$rs=$obj->getthhourdetail($begindate,$enddate,$branchid,$categoryid,$city);
//$rs=$obj->getthplw($begindate,$enddate,$branchid,$categoryid,$city);
$rsthera = $obj->gettherapist($order,$sort,$empid,0,0);
$rsbranch = $obj->getbranch($order,$sort,$branchid,$categoryid,$city);
