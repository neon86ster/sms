...
$querystr = "pageid=$pageid&begin=$hidden_begin&end=$hidden_end&branchid=$branch&payid=$payid&order=$order&sortby=$sortby&cshotel=$cshotel";
	    ...
	    <td valign="top" align="center" height="10">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
			        ...
			        <td class="rheader" height="30" align="right" style="padding-right: 20px; background-image: url('/images/<?=$theme?>/appt/menubg.png');">
				        Branch:
						<?=$obj->makeListbox("branchid","all_bl_branchinfo,al_percent_cms","branch_name","branch_id",$branch,0,"branch_name","branch_active","1","branch_name!='All' and branch_cms=pcms_id and pcms_percent>0")?>
					</td>
		  		</tr>
		    	<tr bgcolor="#999999">
			      ...
			      <tr>
			        ...
			        Sort by:&nbsp;&nbsp;
				        <select id="order" name="order">
				          ...
				          <option title="Payment Type " value="Payment Type" <?=($order=="Payment Type")?"selected":""?>>Payment Type</option>
				         </select>
					...
					&nbsp;&nbsp;
			        	 Customer Hotel: 
			        	  <? $cityid=$obj->getIdToText($branch,"bl_branchinfo","city_id","branch_id");?>		         
			          	  <?if($cityid){?>
			          	  <?=$obj->makeListbox("cshotel","all_al_accomodations","acc_name","acc_id",$cshotel,false,"Replace(acc_name,' ','')","acc_active",1,"city_id=$cityid","acc_id=1",false,false,false,"this.className='ctrDropDown'")?>
			          	  <?}else{?>
			          	  <?=$obj->makeListbox("cshotel","all_al_accomodations","acc_name","acc_id",$cshotel,false,"Replace(acc_name,' ','')","acc_active",1,"","acc_id=1",false,false,false,"this.className='ctrDropDown'")?>	
			          	  <?}?>
			          </td>
			        </tr>
			      <tr bgcolor="#999999">
