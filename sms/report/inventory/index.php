...
$column = $obj->getParameter("column","Branch");
...
$querystr = "pageid=$pageid&begin=$hidden_begin&end=$hidden_end&date=$date&column=$column&order=$order&Collapse=$collapse&branchid=$branch&showall=$showallchk&sortby=$sortby";
...
<form name="inventory" id="inventory" action='' method='post' style="padding:0;margin:0">
			      ...
			      <tr>
			        ...
			        <td class="rheader" height="30" align="right" style="padding-left: 20px; background-image: url('/images/<?=$theme?>/appt/menubg.png');">
				        ...
				        <select id="column" name="column">
				          ...
				          <option title="Branch" value="Branch" <?=($column=="Branch")?"selected":""?>>Branch</option>
				        </select>
						Sort by:
