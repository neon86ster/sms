...
$order = $obj->getParameter("order","Employee Code");
...
$thname = $obj->getParameter("thname",0);
if($order=="Total"){
	$collapse = "Expand";
}
$thname = $obj->getParameter("thname",0);
$empid=($thname==1||!$thname)?0:$thname;
$sortby = $obj->getParameter("chksortby","Z &gt A");
$querystr = "pageid=$pageid&begin=$hidden_begin&end=$hidden_end&date=$date&empid=$empid&column=$column&order=$order&Collapse=$collapse&sortby=$sortby";
    		...
    		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        <td height="30" class="rheader" style="padding-left: 20px;background-image: url('/images/<?=$theme?>/appt/menubg.png');"> Export:&nbsp;&nbsp;
			         	...
			         	&nbsp;&nbsp;Therapist Name:&nbsp;&nbsp;
						<?=$obj->makeTherapistlist("thname",$thname,0,"l_employee.branch_id,l_employee.emp_code,l_employee.emp_nickname")?>
			          </td>
			        </tr>
			      <tr bgcolor="#999999">
