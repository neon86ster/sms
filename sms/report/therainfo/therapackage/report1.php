...
$rs = $obj->getthpackageinfo(0,$begin_date,$end_date);
for($j=0; $j<$rs["rows"]; $j++){
	$total[$j]=$rs[$j]["total"];
}
...
$reportname = "Therapist's Packages Report";
...
<?
		for($j=0; $j<$rsbranch["rows"]; $j++) {		// start branch loop
				...
				<td colspan="<?=($column=="Total only")?$rsdate["rows"]:$rsdate["rows"]+1?>" style="padding-left: 20px;">&nbsp;</td>
					...
					for($k=0; $k<$rsthera["rows"]; $k++) { 	// start branch name loop
						...
						<tr height="22">
							...
							?>		
								<td align="right">
									<?if($export==false){?><a href="javascript:;" class="pagelink" style="text-decoration:none;" onClick="openthpackageDetail(<?=$rsdate["begin"][$d].",".$rsdate["end"][$d].",".$rsthera[$k]["emp_id"].",".$rscity[$i]["city_id"].",0,''"?>)"><? } ?>
									<?= number_format(str_replace(".5",".3",$tmp[$k][$d]),2,".",",") 	?>
									<?if($export==false){?></a><? } ?>
								</td>
								<? } ?>	
							<? 
							   if($column!="Total only"){ ?>
							<td align="right">
							<?if($export==false){?><a href="javascript:;" class="pagelink" style="text-decoration:none;" onClick="openthpackageDetail(<?=$rsdate["begin"][0].",".$rsdate["end"][$d-1].",".$rsthera[$k]["emp_id"].",".$rscity[$i]["city_id"].",0,''"?>)"><?}?>
							<?= number_format(str_replace(".5",".3",$total[$k]),2,".",",")?>
							<?if($export==false){?></a><?}?>
							</td>
							<? } ?>
			...
			<tr height="28">
				...
				?>		
				<td align="right" style="border-top:1px #000000 solid;">
				<?if($export==false){?><a href="javascript:;" style="text-decoration:none;" onClick="openthpackageDetail(<?=$rsdate["begin"][$d].",".$rsdate["end"][$d].",0,".$rscity[$i]["city_id"].",".$rsbranch[$j]["branch_id"].",''"?>)"><?}?>
				<?=number_format(str_replace(".5",".3",$bttotal[$i][$j][$d]),2,".",",")?>
				<?if($export==false){?></a><?}?>
				</td>
				<? }  ?>	
				<? if($column!="Total only"){ ?>
				<td align="right" style="border-top:1px #000000 solid;">
				<?if($export==false){?><a href="javascript:;" style="text-decoration:none;" onClick="openthpackageDetail(<?=$rsdate["begin"][0].",".$rsdate["end"][$d-1].",0,".$rscity[$i]["city_id"].",".$rsbranch[$j]["branch_id"].",''"?>)"><?}?>
				<?=number_format(str_replace(".5",".3",$allbttotal[$i][$j]),2,".",",")?>
				<?if($export==false){?></a><?}?>
				</td>
				<? } ?>
		...
		<tr height="35">
			...
			<td align="right">
			<?if($export==false){?><a href="javascript:;" style="text-decoration:none;" onClick="openthpackageDetail(<?=$rsdate["begin"][0].",".$rsdate["end"][$d-1].",0,".$rscity[$i]["city_id"].",0,''"?>)"><?}?>
			<b><?=number_format(str_replace(".5",".3",$allltotal[$i]),2,".",",")?></b>
			<?if($export==false){?></a><?}?>
			</td>
		</tr>
...
?>		
			<td align="right">
			<?if($export==false){?><a href="javascript:;" class="pagelink" style="text-decoration:none;" onClick="openthpackageDetail(<?=$rsdate["begin"][$d].",".$rsdate["end"][$d].",".$rsthera[$k]["emp_id"].",0,0,''"?>)"><?}?>
			<?=number_format(str_replace(".5",".3",$tmp[$k][$d]),2,".",",") 	?>
			<?if($export==false){?></a><?}?>
			</td>
<?
...
?>
			<? if($column!="Total only"){ ?>
			<td align="right">
			<?if($export==false){?><a href="javascript:;" class="pagelink" style="text-decoration:none;" onClick="openthpackageDetail(<?=$rsdate["begin"][0].",".$rsdate["end"][$d-1].",".$rsthera[$k]["emp_id"].",0,0,''"?>)"><?}?>
			<?= number_format(str_replace(".5",".3",$total[$k]),2,".",",")?>
			<?if($export==false){?></a><?}?>
			</td>
			<? } ?>
...
?>		
			<td align="right">
			<?if($export==false){?><a href="javascript:;" class="pagelink" style="text-decoration:none;" onClick="openthpackageDetail(<?=$rsdate["begin"][$d].",".$rsdate["end"][$d].",".$tmpemptotal[$k][0].",0,0,''"?>)"><?}?>
...
?>
			<? if($column!="Total only"){ ?>
			<td align="right">
			<?if($export==false){?><a href="javascript:;" class="pagelink" style="text-decoration:none;" onClick="openthpackageDetail(<?=$rsdate["begin"][0].",".$rsdate["end"][$d-1].",".$tmpemptotal[$k][0].",0,0,''"?>)"><?}?>
			<?= number_format(str_replace(".5",".3",$total[$k]),2,".",",")?>
			<?if($export==false){?></a><?}?>
			</td>
			<? } ?>
...
for($d=0;$d<$rsdate["rows"];$d++){ // start branch total loop
		echo "<td style=\"padding-left: 20px; white-space: nowrap;\" align=\"right\" bgcolor=\"#d3d3d3\"><b>";
		if($export==false){echo "<a href=\"javascript:;\" style=\"text-decoration:none;\" onClick=\"openthpackageDetail(".$rsdate["begin"][$d].",".$rsdate["end"][$d].",0,0,0,'')\">".number_format(str_replace(".5",".3",$alldatetotal[$d]),2,".",",")."</a></b></td>";}
...
?>
			...
			<td align="right" bgcolor="#d3d3d3"><b>
			<?if($export==false){?><a href="javascript:;" style="text-decoration:none;" onClick="openthpackageDetail(<?=$rsdate["begin"][0].",".$rsdate["end"][$d-1].",0,0,0,''"?>)"><?}?>
			<?=number_format(str_replace(".5",".3",$alltotal),2,".",",")?>
