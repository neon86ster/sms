...
if($export=="Excel" && $chkPageView){
	...
	header("Content-Disposition: attachment; filename=\"Therapist Package Detail.xls\"");
...
$rs=$obj->getthpackagedetail($begin_date,$end_date,$empid,$packageid,$branchid,$city);
$rsthera = $obj->gettherapist($order,$sort,$empid,0,$city);
$rsbranch = $obj->getbranch($order,$sort,$branchid,$city);
$reportname = "Therapist Package Detail";
