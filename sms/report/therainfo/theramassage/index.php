...
$querystr = "pageid=$pageid&branchid=$branchid&cityid=$cityid&begin=$hidden_begin&end=$hidden_end&date=$date&msgid=$msgid&column=$column&order=$order&Collapse=$collapse&sortby=$sortby";
...
<form name="theramassage" id="theramassage" action='' method='post' style="padding:0;margin:0">
			      ...
			      <tr>
			        ...
			        <td class="rheader" height="30" align="right" style="padding-left: 20px; background-image: url('/images/<?=$theme?>/appt/menubg.png');">
				        ...
				        <select id="order" name="order">
				          <?if($report=="report1.php"||$report=="manage_theramassageinfo.php"){?>
			         ...
			         <?if($report=="report.php"||$report=="report1.php"){?>
			          &nbsp;&nbsp;Report View:&nbsp;&nbsp;
				        <select id="reportview" name="reportview">
				      		<option title="Massage View" value="report.php" <?=($reportview=="report.php")?"selected":""?>>Massage View</option>
			          ...
			          <?
			          	$back="";
				      	if($report=="manage_theramassageinfo.php"){$back="report.php";}
				      	else if($report=="manage_theramassageinfo1.php"){$back="report1.php";}
				      ?>
