...
$querystr = "pageid=$pageid&begin=$hidden_begin&end=$hidden_end&date=$date&branchid=$branch&cityid=$city&column=$column&order=$order&percent=$percentchk&sortby='+document.getElementById('sort').value+'";
...
<form name="age" id="age" action='' method='post' style="padding:0;margin:0">
