...
$querystr = "pageid=$pageid&begin=$hidden_begin&end=$hidden_end&branchid=$branch&search=$searchstr";
...
<form name="custinfo" id="custinfo" action='' method='post' style="padding:0;margin:0">
    		...
    		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        <td height="30" class="rheader" style="padding-left: 20px;background-image: url('/images/<?=$theme?>/appt/menubg.png');"> Export:&nbsp;&nbsp;
						...
						&nbsp;&nbsp;<input type="button" name="Export" id="Export" value="Export" onClick="window.open('report.php?begin=<?=$hidden_begin?>&end=<?=$hidden_end?>&search='+document.getElementById('search').value+'&export='+document.getElementById('export').value)"/>
						...
						&nbsp;&nbsp;<a href="javascript:;" onClick="searchCust('<?=$hidden_begin?>','<?=$hidden_end?>','<?=$branch?>');" class="top_menu_link" title="Search all customer information.">
				        <img src="/images/btn_search_bg.gif" alt="search" width="16" height="16" border="0"/></a>&nbsp; 
				        <a href="javascript:;" onClick="searchCust('<?=$hidden_begin?>','<?=$hidden_end?>','<?=$branch?>');" class="top_menu_link" title="Search all customer information.">Search</a> &nbsp;
				        <a href="javascript:;" onClick="document.getElementById('search').value='';searchCust('<?=$hidden_begin?>','<?=$hidden_end?>','0');" class="top_menu_link" title="View all customer information.">
				        <img src="/images/btn_show-all_bg.gif" alt="search" width="16" height="16" border="0"/></a>&nbsp; 
				        <a href="javascript:;" onClick="document.getElementById('search').value='';searchCust('<?=$hidden_begin?>','<?=$hidden_end?>','0');" class="top_menu_link" title="View all customer information.">View All</a>
				        &nbsp;&nbsp; 
					  </td>
			        </tr>
			      <tr bgcolor="#999999">
