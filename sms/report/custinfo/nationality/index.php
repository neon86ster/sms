...
$querystr = "pageid=$pageid&begin=$hidden_begin&end=$hidden_end&date=$date&column=$column&order=$order&Collapse=$collapse&branchid=$branch&cityid=$cityid&showall=$showallchk&sortby=$sortby";
    		...
    		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        <td height="30" class="rheader" style="padding-left: 20px;background-image: url('/images/<?=$theme?>/appt/menubg.png');"> Export:&nbsp;&nbsp;
			          ...
			          &nbsp;&nbsp;percent
			          &nbsp;&nbsp;<input type="checkbox" name="showall" id="showall" value="checked" <?=$showallchk?>/> 
			          &nbsp;&nbsp;show all
			          -->
					  </td>
			        </tr>
