...
$nationalityid = $obj->getParameter("nationality");
$continentid = $obj->getParameter("continent");
$order= $obj->getParameter("order");
$sort= $obj->getParameter("sortby");

$rs=$obj->getcustnationdetail($begin_date,$end_date,$nationalityid,$continentid);

$reportname = "Customer Nationality Detail";
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr height="32">
					...
					<td align="center" style="border-top:2px #000000 solid;border-bottom:2px #ff0000 solid;"><b>Customer Nationality</b></td>
	</tr>
<?
...
$csname = $rs[$i]["cs_name"];
$csnation = $rs[$i]["nationality_name"];
?>
			<tr <?=$bgcolor?> height="20">
					...
					<td class="report" align="center"><?=$csnation?>&nbsp;</td>
			</tr>
<?
}
?>
