...
$querystr = "pageid=$pageid&begin=$hidden_begin&end=$hidden_end" .
		"&nationality=$nationalityid&continent=$continentid" .
		"&order=$order&sortby=$sort";
?>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Customer Nationality</title>
    		...
    		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        <td height="30" class="rheader" style="padding-left: 20px;background-image: url('/images/<?=$theme?>/appt/menubg.png');"> Export:&nbsp;&nbsp;
						...
						<input type="hidden" id="nationality" name="nationality" value="<?=$nationalityid?>"/>
						<input type="hidden" id="continent" name="continent" value="<?=$continentid?>"/>
