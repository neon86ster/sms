...
//$resident = $obj->getParameter("resident","Total");
...
$querystr = "pageid=$pageid&begin=$hidden_begin&end=$hidden_end&date=$date&column=$column&order=$order&cityid=$cityid&branchid=$branch&Collapse=$collapse&percent=$percentchk&sortby=$sortby";
...
<form name="lorv" id='lorv' action='' method='post' style="padding:0;margin:0">
			      ...
			      <tr>
			       ...
			       To: <input id='end' name='end' value="<?=$end?>" readonly="1" class="textbox" type="text" style="width:85px"/>
			        ...
			        <select id="order" name="order">
			          ...
			          <option title="Total Resident" value="Total Resident" <?=($order=="Total Resident")?"selected":""?>>Total Resident</option>
			          <option title="Total Visitor" value="Total Visitor" <?=($order=="Total Visitor")?"selected":""?>>Total Visitor</option>
