...
$querystr = "pageid=$pageid&begin=$hidden_begin&end=$hidden_end&branchid=$branch&cityid=$cityid&order=$order&sortby=$sortby&Collapse=$collapse&commission=$cmschk&search='+document.getElementById('search').value.replace('+','%2B')+'";
...
<form name="bookingcomcms" id="bookingcomcms"  action='' method='post' style="padding:0;margin:0">
			        ...
			        <td class="rheader" height="30" style="padding-left: 20px;background-image: url('/images/<?=$theme?>/appt/menubg.png');">
				        ...
				        <select id="order" name="order">
				          <option title="Alphabet" value="Alphabet" <?=($order=="Alphabet")?"selected":""?>>Alphabet</option>
				           <option title="DDC" value="DDC" <?=($order=="DDC")?"selected":""?>>DDC</option>
			        ...
			        <td height="30" class="rheader" style="padding-left: 20px;background-image: url('/images/<?=$theme?>/appt/menubg.png');"> Export:&nbsp;&nbsp;
			          ...
			          <td height="30" class="rheader" style="padding-left: 20px;background-image: url('/images/<?=$theme?>/appt/menubg.png');"> 
				       <input type="text" name="search" id="search" <?=($search)?"value='$search'":""?> title="Search Commissions by phone."/>
				        ...
				        &nbsp;&nbsp;<a href="javascript:;" onClick="document.bookingcomcms.submit();" class="top_menu_link" title="Search by booking person,phone and customer name only.">
				        <img src="/images/btn_search_bg.gif" alt="search" width="16" height="16" border="0"/></a>&nbsp; 
				        <a href="javascript:;" onClick="document.bookingcomcms.submit();">Search</a> &nbsp;
				        
				        <a href="javascript:;" onClick="document.getElementById('search').value='';getReturnText('report.php','begin=<?=$hidden_begin?>&end=<?=$hidden_end?>&branchid=<?=$branch?>&cityid=<?=$cityid?>&order=<?=$order?>&sortby=<?$sortby?>&commission=<?=$cmschk?>&Collapse=<?=$collapse?>&search=','tableDisplay')" class="top_menu_link" title="View all commission dispersed.">
				        <img src="/images/btn_show-all_bg.gif" alt="search" width="16" height="16" border="0"/></a>&nbsp; 
				        <a href="javascript:;" onClick="document.getElementById('search').value='';getReturnText('report.php','begin=<?=$hidden_begin?>&end=<?=$hidden_end?>&branchid=<?=$branch?>&cityid=<?=$cityid?>&order=<?=$order?>&sortby=<?$sortby?>&commission=<?=$cmschk?>&Collapse=<?=$collapse?>&search=','tableDisplay')" class="top_menu_link" title="View all commission dispersed.">View All</a>
				        &nbsp;&nbsp; 
					  </td>
			        </tr>
			      <tr bgcolor="#999999">
