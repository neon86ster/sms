...
$querystr = "pageid=$pageid&begin=$hidden_begin&end=$hidden_end&hotelid=$hotelid&Collapse=$collapse&branchid=$branch&cityid=$city";
...
<form name="hotelcms" id="hotelcms"  action='' method='post' style="padding:0;margin:0">
    		...
    		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        <td height="30" class="rheader" style="padding-left: 20px;background-image: url('/images/<?=$theme?>/appt/menubg.png');"> Export:&nbsp;&nbsp;
			          ...
			          &nbsp;&nbsp;<input type="button" name="Export" id="Export" value="Export" onClick="window.open('report.php?begin=<?=$hidden_begin?>&end=<?=$hidden_end?>&hotelid=<?=$hotelid?>&Collapse=<?=$collapse?>&export='+document.getElementById('export').value)"/>
			          <!--
			          ...
			          &nbsp;&nbsp;<input type="submit" name="Refresh" id="Refresh" value="Refresh" />
						...
						<?=$obj->makehotelcmslistbox($hotelid)?>
         	 		</td>    	
