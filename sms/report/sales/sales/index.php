...
$querystr = "pageid=$pageid&begin=$hidden_begin&end=$hidden_end&date=$date&column=$column&order=$order&Collapse=$collapse&showall=$showallchk&sortby=$sortby";
...
<form name="sale" id="sale" action='' method='post' style="padding:0;margin:0">
