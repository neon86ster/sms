...
if(!$branch){
	$sql_getbl="select branch_id from bl_branchinfo where branch_id<>1 order by branch_name ";
	$rs_bl=$obj->getResult($sql_getbl);
	$branch = $rs_bl[0]["branch_id"];
}
*/

$querystr = "pageid=$pageid&begin=$hidden_begin&end=$hidden_end&branchid=$branch&cityid=$city&peid=$peid";
	    ...
	    <td valign="top" align="center" height="10">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
			        ...
			        <td class="rheader" height="30" align="left" style="padding-right: 20px; background-image: url('/images/<?=$theme?>/appt/menubg.png');">
				        Time Period:&nbsp;&nbsp;
				       <?=$obj->makeListbox("peid","l_timeperiod","tp_name","tp_id",$peid,0,"tp_name")?>
					</td>

			        <td class="rheader" height="30" align="right" style="padding-right: 20px; background-image: url('/images/<?=$theme?>/appt/menubg.png');">
				        Branch:&nbsp;&nbsp;
				        <?=$obj->makeListbox("branchid","all_bl_branchinfo","branch_name","branch_id",$branch,0,"branch_name","branch_active","1","branch_name!='All' and branch_utilization<>1 ")?>
					</td>	
		  		</tr>
		    	<tr bgcolor="#999999">
