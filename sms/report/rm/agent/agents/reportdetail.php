...
$city_id = $obj->getParameter("cityid",1);
$bpid = $obj->getParameter("bpid",0);

$querystr = "pageid=$pageid&begin=$hidden_begin&end=$hidden_end" .
		"&branchid=$branch_id&cityid=$city_id&bpid=$bpid";
?>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Agents Relationship Management Report Detail</title>
    		...
    		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        <td height="30" class="rheader" style="padding-left: 20px;background-image: url('/images/<?=$theme?>/appt/menubg.png');"> Export:&nbsp;&nbsp;
						...
						<input type="hidden" id="cityid" name="cityid" value="<?=$city_id?>"/>
