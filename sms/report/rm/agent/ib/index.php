...
$querystr = "pageid=$pageid&begin=$hidden_begin&end=$hidden_end&branchid=$branchid&cityid=$cityid&search=$searchstr";
    		...
    		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        <td height="30" class="rheader" style="padding-left: 20px;background-image: url('/images/<?=$theme?>/appt/menubg.png');"> Export:&nbsp;&nbsp;
						...
						&nbsp;&nbsp;<input type="button" name="Export" id="Export" value="Export" onClick="window.open('report.php?begin=<?=$hidden_begin?>&end=<?=$hidden_end?>&branchid=<?=$branchid?>&cityid=<?=$cityid?>&search='+document.getElementById('search').value+'&export='+document.getElementById('export').value)"/>
