...
$branch = $obj->getParameter("branchid","0");	// change default 5 >> 1 natt/June 17,2009
...
$querystr = "pageid=$pageid&begin=$hidden_begin&end=$hidden_end&branchid=$branch&cityid=$cityid&category=$category&column=$column&order=$order&sortby=$sortby";
...
<form name="csigraph" id="csigraph" action='' method='post' style="padding:0;margin:0">
 	...
 	<tr>
    	<td valign="top" height="20px">
    		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        <td height="30" class="rheader" width="337" style="padding-left: 20px;background-image: url('/images/<?=$theme?>/appt/menubg.png');"> Export:&nbsp;&nbsp;
          			...
          			<td width="550" height="30" class="rheader" style="padding-left: 20px;background-image: url('/images/<?=$theme?>/appt/menubg.png');"> 
						Category:&nbsp;&nbsp;
						<?=$obj->makeListbox("category","all_fl_csi_index","csii_name","csii_id",$category,0,"csii_name","csii_active","1")?>
				        <? if($category!="0"){ ?>
						&nbsp;&nbsp;Columns:&nbsp;&nbsp;
