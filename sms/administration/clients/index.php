...
<form name="clients" id="clients" action="index.php" method="post" style="padding:0;margin:0">
    	...
    	<td align="right" height="30px" class="rheader">
    		<table border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        ...
			        <?	
			        	$chksql = "select client_id from p_clientinfo ";
			        	$search = strtolower($search);
			        	$chksql .= "where (lower(client_name) like '%$search%' " .
