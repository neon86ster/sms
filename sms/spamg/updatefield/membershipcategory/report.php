...
if(!$showinactive){$sql .= "and category_active=1 ";}
				...
				if($arrFields[$j]=='category_active') {
					if($chkPageEdit){
						if($rs[$i]["category_active"]==1){
							$data = "<a href=\"javascript:;\" onClick=\"setEnable('mb_category',".$rs[$i]["category_id"].",0);\"\>".
								 "<img src=\"/images/active.png\" border=\"0\" title=\"active\" /></a>";
						}else{
							$data = "<a href=\"javascript:;\" onClick=\"setEnable('mb_category',".$rs[$i]["category_id"].",1);\">".
