        	...
        	<div id="gform">
                    ...
                    <table boder="0" cellpadding="0" cellspacing="0" width="100%" class="generalinfo" style="margin-top:0px;">
                		...
                		<fieldset>
							...
							<input name="add" id="add" type="button" size="" value="<?=($categoryid)?" save change ":" add "?>" onClick='<?=($categoryid)?"set_editData(\"mb_category\",$categoryid)":"set_insertData(\"mb_category\")"?>' > 
