...
$showinactive=$obj->getParameter("showinactive",0);	// add showinactive natt/June 17,2009
...
$querystr = "pageid=$pageid&search=$searchstr&sort=$sort&order=$order&page=$page&showinactive=$showinactive";	// add showinactive natt/June 17,2009
?>
<html>
<head>
...
<div id="header">
	...
	<tr>
 	...
 	<tr>
	 	...
	 	<?=(isset($pageinfo["pagename"]))?$pageinfo["pagename"]:""?> Information 
    	...
    	<td align="right" height="30px" class="rheader">
    		<table border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        ...
			        <?	
			        	$chksql = "select emp_department_id from l_employee_department ";
			        	$search = strtolower($search);
			        	$chksql .= "where lower(emp_department_name) like '%$search%' ";
						if(!$showinactive){$chksql .= "and emp_department_active=1 ";}
