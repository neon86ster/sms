        	...
        	<div>
        		        <? 
							if($nationid){
									...
									"<where name='pay_id' operator='='>$nationid</where>" .
									"</command>";
                    ...
                    <table boder="0" cellpadding="0" cellspacing="0" width="100%" class="generalinfo" style="margin-top:0px;">
                		...
                		<fieldset>
							...
							<input name="add" id="add" type="button" size="" value="<?=($nationid)?" save change ":" add "?>" onClick='<?=($nationid)?"set_editData(\"l_paytype\",$nationid)":"set_insertData(\"l_paytype\")"?>' > 
