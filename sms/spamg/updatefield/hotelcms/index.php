    	...
    	<td valign="top" height="30px" colspan="2" class="rheader">
    		<table border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        ...
			        City: <?=$obj->makeListbox("cityid","all_al_city","city_name","city_id",$cityid,0,"city_name",0,0,0,0,0,"sortInfo('','1');")?>
    	...
    	<td align="right" height="30px" class="rheader">
    		<table border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        ...
			        <?	
			        	$sql1 = "select acc_id from al_accomodations where acc_id!=1 and acc_active=1 ";
			        	$sql2 = "select bp_id as acc_id from al_bookparty where bp_id!=1 and bp_active=1 ";
