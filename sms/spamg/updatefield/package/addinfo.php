...
$last_ctrmid = $obj->getParameter("lastgroupid");
        	...
        	<div>
        		        <? 
							if($packageid){
									...
									"<where name='package_id' operator='='>$packageid</where>" .
									"</command>";
                    ...
                    <table boder="0" cellpadding="0" cellspacing="0" width="100%" class="generalinfo" style="margin-top:0px;">
                		...
                		<fieldset>
                    		...
                    		<input name="id" id="id" type="hidden" value="<?=$packageid?>">
							<input name="add" id="add" type="button" size="" value="<?=($packageid)?" save change ":" add "?>" onClick='<?=($packageid)?"set_editData(\"db_package\",$packageid)":"set_insertData(\"db_package\")"?>' > 
