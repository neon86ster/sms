    	...
    	<td align="right" height="30px" class="rheader">
    		<table border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        ...
			        <?	
			        	$chksql = "select package_id from db_package ";
			        	$search = strtolower($search);
						$chksql .= "where package_id=package_id ";
						if(!$showinactive){$chksql .= "and package_active=1 ";}
						$chksql .= "and (lower(package_name) like '%$search%' "  .
								"or lower(REPLACE(package_detail,\"[br]\",\"\")) like '%$search%' "  .
								"or hour like '%$search%' "  .
