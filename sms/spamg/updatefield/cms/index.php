    	...
    	<td align="right" height="30px" class="rheader">
    		<table border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        ...
			        <?	
			        	$chksql = "select pcms_id from al_percent_cms ";
			        	$search = strtolower($search);
						$searchsql = $obj->convert_char($search);
			        	$chksql .= "where (lower(pcms_percent) like '%$searchsql%' " .
			        				"or lower(pcms_detail) like '%$searchsql%') ";
						if(!$showinactive){$chksql .= "and pcms_active=1 ";}
