...
$querystr = "pageid=$pageid&search=$searchstr&sort=$sort&order=$order&page=$page&showdetail=$showdetail";	// add showinactive natt/June 17,2009
?>
<html>
<head>
...
<form name="csivalue" id="csivalue" action="" method="post" style="padding:0;margin:0">
    	...
    	<td align="right" height="30px" class="rheader">
    		<table border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        ...
			        <?	
			        	$chksql = "select csii_id from fl_csi_index ";
			        	$search = strtolower($search);
						$searchsql = $obj->convert_char($search);
			        	$chksql .= "where csii_active = 1 " .
