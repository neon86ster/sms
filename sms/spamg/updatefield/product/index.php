...
$querystr = "pageid=$pageid&search=$searchstr&sort=$sort&order=$order&page=$page&showinactive=$showinactive&categoryid=".$categoryid;
?>
<html>
<head>
    	...
    	<td valign="top" height="30px" colspan="2" class="rheader">
    		<table border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        ...
			        <?=$obj->makeListbox("categoryid","all_cl_product_category","pd_category_name","pd_category_id",$categoryid,0,"pd_category_name","pd_category_active","1",0,0,0,"document.getElementById('page').value=1;sortInfo('','1');")?>
			        </span>
    	...
    	<td align="right" height="30px" class="rheader">
    		<table border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        ...
			        <?	
			        	$sql = "select pd_id from cl_product ";
						...
						if($categoryid){$sql .= "and pd_category_id=$categoryid ";}
							...
							if($categoryid){
								...
								"or lower(pd_detail) like '%$search%' ";
							}
						}
