...
$order=$obj->getParameter("order","rec_name");
...
$sql .= "where lower(rec_name) like '%$search%' ";
...
<?		}
	...
	if($chkPageEdit){
		echo "<td class=\"report\"><a href=\"javascript:;\" onclick=\"editData('$tbname','".$rs[$i]["rec_id"]."')\">update</a></td>";
	}
	echo "</tr>";
}
if(!$rs["rows"]){}
