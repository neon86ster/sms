...
$querystr = "pageid=$pageid&search=$searchstr&sort=$sort&order=$order&page=$page&showinactive=$showinactive&cmsid=$cmsid&categoryid=".$categoryid;
    		...
    		<table border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        <td class="rheader" height="30" style="padding-left: 20px;">
			          City:<br><?=$obj->makeListbox("categoryid","all_al_city","city_name","city_id",$categoryid,0,"city_name","city_active","1",0,0,0,"sortInfo('','1');")?>
    	...
    	<td align="right" height="30px" class="rheader">
    		<table border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        ...
			        <?	
			        	$sql = "select acc_id from al_accomodations ";
