...
$querystr = "pageid=$pageid&search=$searchstr&sort=$sort&order=$order&page=$page";	// add showinactive natt/June 17,2009
?>
<html>
<head>
    	...
    	<td align="right" height="30px" class="rheader">
    		<table border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        ...
			        <?	
			        	$chksql = "select csiv_id from fl_csi_value ";
			        	$search = strtolower($search);
						$searchsql = $obj->convert_char($search);
			        	$chksql .= "where csiv_id != 1 " .
