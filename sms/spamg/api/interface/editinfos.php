...
$sql_save="UPDATE c_account_deposit 
SET account_name='$n1',name='$n2',branch_id='$n3', account_num='$n4',template='$n5' WHERE account_id='$n' " ;
		...
		<td height="47" style="background-image: url('/images/<?=$theme?>/header.png');">
						 <table height="47" border="0" cellpadding="0" cellspacing="0" style='overflow:auto;' class="dir">
					         <tbody>
						         ...
						         <a href="javascript:;" onclick="gotoURL('index.php?pageid=4')" target="mainFrame">Prefrences &gt</a>
...
$sql= "select * from c_account_deposit where account_id='$n'" ;
...
<tr>
<td>Customer Name</td>
<td><input type=text name=n1 value="<?=$n1=$aa[$x]["account_name"]?>"></td>
</tr>
<tr>
<td>Transection</td>
