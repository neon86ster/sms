...
$sql_save="INSERT INTO c_account_deposit 
( account_id, name, account_name, branch_id, account_num,template ) VALUES( \"\" ,\"$n2\" , \"$n1\" , \"$n3\" , \"$n4\" , \"$n5\" ) " ; 
...
<tr>
<td>Customer Name</td>
<td><input type=text name=n1 <?=$n1?>></td>
</tr>
<tr>
<td>Transection</td>
<td><input type=text name=n2 <?=$n2?>></td>
</tr>
<tr>
<td>Branch</td>
<td><select name=n3> 
...
<!--<td>Branch</td>
<td><input type=text name=n3 <?=$n3?>></td>-->
</tr>
<tr>
...
<!--<td><input type=text name=n4 <?=$n4?>></td>-->
</tr>
<tr>
<td>Template</td>
<td><select name=n5> 
...
<!--<td><input type=text name=n5 <?=$n5?>></td>-->
</tr>
</table> 
