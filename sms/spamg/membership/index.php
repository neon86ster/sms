			      ...
			      <tr>
			        ...
			        <input type="hidden" name="order" id="order" value="<?=$order?>">&nbsp;
						...
						<input type="text" name="search" id="search" <?=($search)?"value='".$search."'":""?>/>
     					...
     					&nbsp;&nbsp;
        			    <a href="javascript:;" onClick="sortInfo(0,'1')"><img src="/images/<?=$theme?>/search.png" alt="search" border="0"/></a>
        			    <a href="javascript:;" onClick="document.getElementById('search').value='';sortInfo(0,'1')"><img src="/images/<?=$theme?>/view.png" alt="view all" border="0"/></a> 
        			    <a href="javascript:;" onClick="sortInfo(0,'<?=$page?>')"><img src="/images/<?=$theme?>/refresh.png" alt="refresh" border="0"/></a>&nbsp; 
        			</td>
			       </tr>
    		</table>
  		</td>
			        ...
			        <?	
			        	...
			        	if($categoryid){
			        		$sql .= "where category_id=$categoryid " .
			        				"and (lower(member_code) like '%$search%' " .
			        				"or lower(fname) like '%$search%' " .
			        				"or lower(mname) like '%$search%' " .
			        				"or lower(lname) like '%$search%' " .
			        				"or lower(birthdate) like '%$search%' " .
			        				"or REPLACE(mobile,\"-\",\"\") like '%$search%') ";
			        	}else{
			        		$sql .= "where lower(member_code) like '%$search%' " .
			        				"or lower(fname) like '%$search%' " .
			        				"or lower(mname) like '%$search%' " .
			        				"or lower(lname) like '%$search%' " .
			        				"or lower(birthdate) like '%$search%' " .
