...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
    		...
    		<br /><br />
			<b class="welcomecompany"><?=$rs["pagename"]?></b>
			<br /><br />
                  ...
                  <? for($i=0;$i<$rs["rows"];$i++){ 
                    ...
                    <table width="96" height="89" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          onclick="gotoURL('<?=$rs[$i]["url"]?>');" align="center" 
                    ...
                    <a href="javascript:;" onClick="gotoURL('<?=$rs[$i]["url"]?>')" target="mainFrame" style="color:<?=$fontcolor?>"><b><?=$rs[$i]["page_name"]?></b></a>
                    </td>
                    <? } ?>
                  </tr>
                </tbody>
