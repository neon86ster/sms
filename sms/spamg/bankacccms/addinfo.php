...
<td>Add time : <?=date("d-M-y H:i:s")?></td> 
                    ...
                    <table boder="0" cellpadding="0" cellspacing="0" width="100%" class="generalinfo" style="margin-top:0px;">
                		...
                		<fieldset>
							...
							<input name="add" id="add" type="button" size="" value="<?=($bankacccmsid)?" save change ":" add "?>" onClick='<?=($bankacccmsid)?"set_editData(\"al_bankacc_cms\",$bankacccmsid)":"set_insertData(\"al_bankacc_cms\")"?>' > 
