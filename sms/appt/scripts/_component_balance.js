...
function checkBPphone(inputobject,oldbpphone){	
    ...
    if(!pattern.test(inputvalue)&&inputvalue!=""){           
    	alert("Please check on B.P. Phone Number!!");  
		inputobject.value = "";
    }
...
function checkCSphone(inputobject){
    ...
    var pattern=/^\+[1-9]{1}\d{0,}$/;
    if(!pattern.test(inputvalue)&&inputvalue!=""){           
    	alert("Please check on Customer Phone Number!!");  
		inputobject.value = "";
    }
}
/*
...
function transferwindow(book_id,time_pu,time_tb){ 
	...
	window.open(url,'trfunit','location=0,toolbar=0,directoris=0,status=0,menubar=0,scrollbars=0,resizable=0,width=250,height=600,left=500,top=100'); 
...
//	tw_comment = tw_comment.value;
	...
	t = "therapist_ws.php?book_id="+book_id+"&branch="+branch+"&cs_name="+cs_name+"&room="+tw_room+tw_hour+tw_name+"&sex="+tw_sex+"&national="+tw_national+"&stream="+tw_stream+"&package="+tw_package+"&bath="+tw_bath+"&facial="+tw_facial+"&wrap="+tw_wrap+tw_msg+"&strength="+tw_strength+"&scrub="+tw_scrub+"&comment="+tw_comment+"&appttime="+appttime+"&apptdate="+apptdate+"";	
	
	//alert(t);
	window.open(t,target,'location=0,toolbar=0,directoris=0,status=0,menubar=0,scrollbars=0,resizable=0,width=245,height=770,left=500,top=50');
...
function newwindow(target,nameofwindow){
	window.open(target,nameofwindow,'height=700,width=1020,resizable=0,scrollbars=1');
}
