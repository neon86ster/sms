...
$querystr = "pageid=$pageid&search=$searchstr&sort=$sort&order=$order&page=$page" .
		"&showinactive=$showinactive&categoryid=$categoryid";
...
$pageinfo["pagename"] = "Code Free/Discount";
?>
<html>
<head>
...
<form name="mkbodeinfo" id="mkbodeinfo" action="" method="post" style="padding:0;margin:0">
    	...
    	<td valign="top" height="30px" colspan="2" class="rheader">
    		<table border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        ...
			        Category: <?=$obj->makeListbox("categoryid","all_l_mkcode_category","category_name","category_id",$categoryid,0,"category_name","category_active","1",0,0,0,"searchInfo('1');")?>
			        ...
			        <input type="hidden" name="order" id="order" value="<?=$order?>">&nbsp;
        				...
        				&nbsp;&nbsp; 
        				<input id='showinactive' type='checkbox' name='showinactive' value='1' onClick="sortInfo('','','')" <? echo ($showinactive)?"checked":""?> /> Show Inactive
        			</td>
			       </tr>
    		</table>
  		</td>
