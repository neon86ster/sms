...
<!--<input type="button" name="bpAdd" id="bpAdd" value="Add" href="javascript:;" class="button" onClick="Qadd('<?=($rs[$i]["tb_name"]=="al_bookparty")?$rs[$i]["c_bp_id"]:1?>','agent','<?=$rs[$i]["c_bp_person"]?>','<?=$rs[$i]["c_bp_phone"]?>');"/>-->
<?}else{?>
