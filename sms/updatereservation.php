 ...
 include("include.php");
  ...
  for($i=0;$i<$groupRs["rows"];$i++){
  	...
  	$sql = "insert into s_grouptemplate (gpage_id, group_id, page_id, parent_id, menu_level," .
  			...
  			"values ('','".$groupRs[$i]["group_id"]."','106','5','1','Reservations Center','report/res/index.php','0','0','81')";
  	//echo $sql."<br>";
  	//$object->setResult($sql);
  	
  	$sql1 = "insert into s_grouptemplate (gpage_id, group_id, page_id, parent_id, menu_level," .
  			"page_name, url, edit_permission, view_permission, page_priority) " .
  			"values ('','".$groupRs[$i]["group_id"]."','107','106','2','Booking Agent','report/res/agent/index.php','0','0','81')";
  	//$object->setResult($sql1);
  }
  ...
  for($i=0;$i<$userRs["rows"];$i++){
  	...
  	$sql = "insert into s_upage (u_pageid, user_id, group_id, page_id, parent_id, menu_level, page_name" .
  			...
  			"values ('','".$userRs[$i]["user_id"]."','".$userRs[$i]["group_id"]."'," .
  					"'106','5','1','Reservations Center','report/res/index.php','0','0','81')";
  	//echo $sql."<br>";
  	//$object->setResult($sql);
  	$sql1 = "insert into s_upage (u_pageid, user_id, group_id, page_id, parent_id, menu_level, page_name" .
  			", url, edit_permission, view_permission, page_priority) " .
  			"values ('','".$userRs[$i]["user_id"]."','".$userRs[$i]["group_id"]."'," .
  					"'107','106','2','Booking Agent','report/res/agent/index.php','0','0','81')";
  	//$object->setResult($sql1);
  }
